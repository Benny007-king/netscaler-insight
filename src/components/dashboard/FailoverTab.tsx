...
import { Download, Search, Clock, AlertCircle, Info, RefreshCw } from "lucide-react";
        ...
        <div className="flex flex-wrap gap-4 mb-6 p-4 bg-background/50 rounded-xl border border-border/50">
          ...
          <div className="flex items-end gap-3 ml-auto">
            <div className="flex items-center gap-2 px-3 py-2 bg-secondary/50 rounded-lg border border-border/50">
              <Switch
                id="failover-auto-refresh"
                checked={autoRefresh}
                onCheckedChange={setAutoRefresh}
              />
              <Label htmlFor="failover-auto-refresh" className="text-xs text-muted-foreground cursor-pointer flex items-center gap-1.5">
